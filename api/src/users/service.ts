...
export default class UserService {
    ...
    constructor(userCollection: Collection<UserEntity>, hobbyCollection: Collection<Hobby>) {
    ...
    public getUsers(): UserDTO[] {
        ...
        return this.userRepository.getUsers().map<UserDTO>((user: UserEntity & LokiObj): UserDTO => this.userEntityToUserDTO(user, hobbiesMap));
    }
    ...
    private userEntityToUserDTO(user: UserEntity & LokiObj, hobbiesMap: Record<string, string>): UserDTO {
